...
class Test_100_Utils_ustr(BaseTestCase):
    ...
    def test_ustr_unicode(self):
        ...
        self.assertIsInstance(ustr(u"Юнікод"), str)
        self.assertIs(ustr(u"Юнікод"), u"Юнікод")

    def test_ustr_bytes(self):
        ustr = utils.ustr

        self.assertIsInstance(u"Юнікод".encode("utf-8"), bytes)
        self.assertIsInstance(ustr(u"Юнікод".encode("utf-8")), str)
    ...
    def test_ustr_bytes_cp1251(self):
        ...
        self.assertIsInstance(u"Юнікод".encode("cp1251"), bytes)
    ...
    def test_ustr_uobj(self):
        ...
        self.assertIsInstance(ustr(self.uobj), str)
        self.assertEqual(ustr(self.uobj), u"Юнікод")

    def test_ustr_bobj(self):
        ustr = utils.ustr

        self.assertIsInstance(ustr(self.bobj), str)
    ...
    def test_ustr2_bytes_cp1251(self):
        ...
        self.assertIsInstance(u"Юнікод".encode("cp1251"), bytes)
        self.assertIsInstance(ustr(u"Юнікод".encode("cp1251")), str)
        self.assertEqual(ustr(u"Юнікод".encode("cp1251")), u"Юнікод")
